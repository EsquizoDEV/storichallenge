...
function hashPasswords(users) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, users_1, user, hashedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log("INSERT INTO \"users\" (name, email, password, role) VALUES ('".concat(user.name, "', '").concat(user.email, "', '").concat(hashedPassword, "', '").concat(user.role, "');"));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
